      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <nav className="mb-10 p-4 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <ol className="space-y-1 text-sm">
            <li>
              <a href="#what-is-a-token" className="text-indigo-600 hover:text-indigo-800 hover:underline">
                1. What is a token in AI?
              </a>
            </li>
            <li>
              <a href="#how-are-tokens-counted" className="text-indigo-600 hover:text-indigo-800 hover:underline">
                2. How are tokens counted? (with examples)
              </a>
            </li>
            <li>
              <a href="#why-do-tokens-cost-money" className="text-indigo-600 hover:text-indigo-800 hover:underline">
                3. Why do tokens cost money?
              </a>
            </li>
            <li>
              <a href="#how-many-tokens" className="text-indigo-600 hover:text-indigo-800 hover:underline">
                4. How many tokens is my text?
              </a>
            </li>
            <li>
              <a href="#token-limits-by-model" className="text-indigo-600 hover:text-indigo-800 hover:underline">
                5. Token limits by model
              </a>
            </li>
            <li>
              <a href="#token-cost-calculator" className="text-indigo-600 hover:text-indigo-800 hover:underline">
        ...
        <section id="what-is-a-token" className="mb-12 scroll-mt-6">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <code className="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono">the</code>,{" "}
            <code className="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono">is</code>, and{" "}
            <code className="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono">and</code>{" "}
            are each a single token. Longer or rarer words split into multiple
            tokens:{" "}
            <code className="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono">tokenization</code>{" "}
            becomes{" "}
            <code className="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono">token</code>{" "}
            +{" "}
            <code className="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono">ization</code>.
          </p>
          <p className="text-gray-700 leading-relaxed">
            ...
            <code className="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono">o200k_base</code>)
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-800">~4 tokens</td>
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-800">~75 tokens</td>
                  <td className="py-3 px-4 text-gray-500 hidden sm:table-cell">
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-800">~120 tokens</td>
                  <td className="py-3 px-4 text-gray-500 hidden sm:table-cell">
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-800">~50 tokens</td>
                  <td className="py-3 px-4 text-gray-500 hidden sm:table-cell">
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-800">~750 tokens</td>
                  <td className="py-3 px-4 text-gray-500 hidden sm:table-cell">
        ...
        <section id="how-many-tokens" className="mb-12 scroll-mt-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-2">
            ...
            <li>
              ...
              <code className="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono">~</code>{" "}
              ...
              <tbody className="divide-y divide-gray-100">
                {activeModels.map((model) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-right text-gray-800 font-mono tabular-nums">
